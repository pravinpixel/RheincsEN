<%@ Page Title="News & Events | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="NewsEventsDetails.aspx.cs" Inherits="RheinBrucke.NewsAndEvents.NewsEventsDetails" %>
    ...
    <div class="container" id="container-top">
        <div class="row">
             <ul class="breadcrumb bread  hidden-xs hidden-sm">
                 ...
                 <li><a href="<%= rootpath%>news-events" class="redColor">News & Events <span> » </span> </a></li>
