<%@ Page Title="Resources: Brochures | RheinBrücke" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="brochures.aspx.cs" Inherits="RheinBrucke.Resources.brochures" %>
    ...
    <div class="container" id="container-top">
       <div class="row">
             <ul class="breadcrumb bread hidden-xs hidden-sm">
                 ...
                 <li ><a href="#" class="redColor">Brochures</a></li>
        ...
        <div class="wrappernew main-container">
                    <h1 class="redColor">Brochures</h1>
            </div>
