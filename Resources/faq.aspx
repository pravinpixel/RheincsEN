<%@ Page Title="Unlock Answers: FAQ on ERP | RheinBrücke |Trusted ERP Implementation Partner" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="RheinBrucke.Resources.faq" %>
...
<meta name="description" content="Get clarity on ERP with our comprehensive FAQ. RheinBrücke IT Consulting, your reliable ERP implementation partner, addresses queries & guides to optimized solutions." />
</asp:Content>
...
<script type="application/ld+json">
    {
      ...
      "mainEntity": [{
        ...
        "@type": "Question",
        "name": "What is RheinBrücke vision?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RheinBrücke aims to be a respected player in the Small and Medium Enterprise (SME) landscape, and to be the “Go-To-Company” for IT & ERP solutions in Continental Europe."
        }
      }, {
        "@type": "Question",
        "name": "How is Epicor ERP different?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<ul><li class='faq-bullet'><span class='faq-content'>Epicor ERP has been built from the ground up to comprehensively respond to these needs and provide the support organizations require to thrive in today’s competitive global business landscape.</span></li><li class='faq-bullet'><span class='faq-content'>Epicor ERP streamlines the use of ERP across multiple devices while providing greater deployment choices, reduced complexity, and remarkable ease-of-use.</span></li>
    ...
    <li class='faq-bullet'><span class='faq-content'>Epicor ERP is built on a server architecture fully optimized for Microsoft® Windows® Server and Microsoft SQL Server®. This helps make it simple to manage and very hardware efficient.</span></li>
        ...
        {
        "@type": "Question",
        "name": "What are the advantages of Epicor ERP?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Epicor ERP provides today’s organization with the core technological foundation to meet the difficult and rapidly evolving challenges of today’s global competition. The five principles of Epicor ERP support this: </p>
    <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'><b>Mobility </b> - Epicor ERP is designed to deliver flexibility with 24/7 access to the information wherever and on whatever device.</span></li>
      ...
      {
        "@type": "Question",
        "name": "Is Epicor ERP on the Cloud a good ERP?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<ul>
     ...
     <li class='faq-bullet'><span class='faq-content'>The Critical Capabilities report is aligned with the “2018 Magic Quadrant for Product-Centric Cloud ERP for Midsize Enterprises,” where Epicor ERP has been positioned in the “Visionary” quadrant.</span></li>    </ul>"} 
      },
      {
        "@type": "Question",
        "name": "How does Epicor on the Cloud help Manufacturers?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Some of the capabilities found in the Epicor Cloud ERP solution for Manufacturers include:</p><ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>End-to-end management of complex multi-phase projects</span></li>    </ul>"} 
      },
      {
        "@type": "Question",
        "name": " What are some of the benefits of deploying Epicor ERP in the cloud?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Increase the strategic value of your IT organization by offloading upgrades and administrative tasks to Epicor</span></li>
     ...
     <li class='faq-bullet'><span class='faq-content'>Go live faster with simpler implementation</span></li>
      ...
      {
        "@type": "Question",
        "name": "Is there a defined ERP methodology with standards and guidelines?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>All project members are required to be certified in the methodology that in turn ensures consistency in execution</span></li>
      ...
      {
        "@type": "Question",
        "name": "What are the success factors to the eFusion methodology?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Process Alignment </p>
                        <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Build In-house competence and ownership – process and systems</span></li>
      ...
      {
        "@type": "Question",
        "name": "How are Budgets managed and controlled?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>The Project Management Tools – PSA Platform and Financial Reporting Templates help the customer and project team deliver ERP projects and manage fiscal health using earned value management techniques.</p>"} 
      },
      {
        "@type": "Question",
        "name": "How is Change Management handled?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Change Management in a broader term as ‘Organization Change Management’ has three fronts : </p>
                        <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Readiness Assessments</span></li>
      ...
      {
        "@type": "Question",
        "name": " What are the Best Practices for managing training during an ERP Implementation?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Managing Training is part of the overall Change Management effort in an ERP project and needs the desired attention. Lack of sufficient training / irrelevant training can cause substantial delays in project closure and prolonged settling down time. Best practices are as follows:</p>
                        <ul>
    <li class='faq-bullet'><span class='faq-content'>Embrace Training as part of the OCM Efforts. Follow guidelines below:</span>
                                <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Repeat End User Training every 2 – 3 weeks after Go-Live for around 3 months to ensure that all users have successfully adapted to the new ERP environment </span></li>
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Duration of an ERP implementation may be broadly attributed to the following factors:</p>
                        <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Finance, Supply Chain, Manufacturing, Projects -> 6 – 12 months; depending on size, plants, locations and factors above</span></li>
      ...
      {
        "@type": "Question",
        "name": " What Staffing is required for a successful ERP Implementation outcome?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>Both the Customer and the ERP Implementation partner need to staff the project suited to the different roles each party has to play for a successful ERP Project outcome, viz., Governance, Management and Control and the Core Team. Guidelines for roles of members is below:</p>
                        <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Core Team - One representative per domain to review To Be Processes, prepare SIPOC, Review gaps and sign off workarounds, customization and integration specifications; Sign off Proof of Concept outputs; Own data migration; Validate Designed System; ‘Trainer to End Users’; Super user Post Go-Live – 100% dedicated </span></li>
      ...
      {
        "@type": "Question",
        "name": "  How do you use RPA and Other automation tools in an ERP implementation?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>RPA and other similar automation needs are largely driven by customer needs and based on the industry. Standard introductory RPA processes are included into the standard Out of the Box implementation and supported by the implementation methodology</p><p>The following are a few examples where Epicor ERP framework components are used to deliver RPA objectives:</p>
    <ul>
    ...
    <li class='faq-bullet'><span class='faq-content'>Epicor ATE tool for performance measurements and optimizations</span></li>
      ...
      {
        "@type": "Question",
        "name": "Are there any drawbacks to the Signature implementation methodology? Why is the eFusion methodology better?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <p>While Signature Methodology exists for several decades, it needed alignment to current realities and trends. Signature is a KISS approach (Keep it simple and stupid) providing a repository of templates and an implementation structure. It assumes there would be no ‘Development’ which is healthy but not practical. </p>
      ...
      {
        "@type": "Question",
        "name": "What systems and platforms are used during the ERP implementation process?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <p>Process Models: <b>Epicor Process Reviews and Risk Based Gap Assessments</b></p>
                        <ul>
      ...
      {
        "@type": "Question",
        "name": "How are the ERP Project Risks controlled and Managed?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <p>The PSA Platform facilitates risk management and is part and parcel of the implementation methodology.  Risks are managed throughout the ERP project life cycle and reported at all project reviews and Steering Committee meetings with priority, ownership, business impact and risk management strategy agreed between the implementation and customer teams </p>"}
        },
         {
        "@type": "Question",
        "name": "Is Data Management a risk? What are the recommended Best Practices?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<p>An unstructured approach to data migration can be a major risk to a project causing significant delays and cost overruns and a negative impact on all other initiatives. It is absolutely imperative that a very structured approach be adapted for data migration and follow the implementation methodology – which pays very special attention to data migration and prescribes a very structured approach.</p>"}
        },
        {
         "@type": "Question",
        "name": "What is the approach to process design and re-engineering in an ERP implementation?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <p>Refer to the Success factors. The foundation to a successful implementation is process alignment to Epicor recommended best practices, include only MUST HAVE modifications and phase optimizations to post go-live!  Best practice guidelines below:</p>
                        <ul>
          ...
          {
        "@type": "Question",
        "name": "Is it a one size fits all? How are Large ERP projects different from small ERP Projects?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <p>While it is not a one size fits all, the time also varies based on nature of processes being implemented. Indicative ERP implementation durations are below:</p>
                        <ul>
                           <li class='faq-bullet'><span class='faq-content'>Finance and Supply Chain / Distribution business –> 3 – 6 months; Depending on size / No. Locations and factors above</span></li>
                            <li class='faq-bullet'><span class='faq-content'>Finance, Supply Chain, Manufacturing -> 4 – 8 months; depending on size, No. plants and factors above</span></li>
                           <li class='faq-bullet'><span class='faq-content'>Finance, Supply Chain, Manufacturing, Projects -> 6 – 12 months; depending on size, plants, locations and factors above</span></li>
            ...
            {
        "@type": "Question",
        "name": " How is an ERP Cloud Implementation different from an ERP ON-premise implementation?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": " <ul>
    <li class='faq-bullet'><span class='faq-content'>A cloud implementation is characterized usually by the following traits :</span>
                                <ul>
