<%@ Page Title="PPA | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/campaigns-promotion.Master" AutoEventWireup="true" CodeBehind="promotion.aspx.cs" Inherits="RheinBrucke.campaigns.promotion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="top_box">
        <div class="logo"> <a href="#"><img src="/Assets2/promo/images/ric-logo.png" alt="Ric-logo" /></a> </div>
    ...
    <div id="AllBanner">
        <div class="left_baner" id="Banner1">
            <ul class="owl-carousel" id="home_banner">
                ...
                <li>
                    <img src="/Assets2/promo/img/banner3.jpg" alt="" />
                    <div class="tags">
            ...
            <form id="form1" method="post" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12 no-padding-right">
                         ...
                         <div class="textclass">
                            <input type="text" id="Email1" name="name" class="required " placeholder="Email*" />
                        </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 ">
                        <div class="textclass textclassmob">
                            <span class="button-checkbox">
                                ...
                                <input type="checkbox" name="check1" class="hidden" value="brochure" />
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 ">
                        <div class="textclass textclassmob">
                            <span class="button-checkbox">
                                ...
                                <input type="checkbox" name="check1" class="hidden" value="demo" />
                            </span>
                        </div>
                    </div>
...
<ul class="owl-carousel" id="home_banner1" style="display:none;">
    ...
    <li>
        ...
        <div class="tags">
            <h2>Success Story</h2><h3> The solution is very intuitive, providing very high ease of use, in addition to being very cost effective. Our business users needed minimal training to use this solution. I am very happy with the proactive approach and work done by Team RheinBrücke – CCO, TPCIL.</h3>
        </div>
    </li>
</ul>
