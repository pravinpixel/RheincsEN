<%@ Page Title="Partners Inserito Epicor for construction and EPC Hook up questions" Language="C#" MasterPageFile="~/Campaigns-EPC.Master" AutoEventWireup="true" CodeBehind="epicor-for-construction-and-epc-hook-up-questions-inserito.aspx.cs" Inherits="RheinBrucke.rheinbrucke_solutions.epicor_for_construction_and_epc_hook_up_inserito" %>
            ...
            <nav class="navbar" role="navigation">
                <div class="container">
                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <!-- Logo -->
                        <div class="logo" style="width: 100px; margin-right:20px">
                        ...
                        <div class="logo" style="width:80px">
                            <a class="logo-wrap" href="https://www.inserito.com/" target="_blank">
                                <img class="logo-img logo-img-main" src="../Assets/images/partners/inserito-logo.png" alt="Inserito Logo"/>
                                <img class="logo-img logo-img-active" src="../Assets/images/partners/inserito-logo.png" alt="Inserito Logo"/>
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <h3 class="footer-h3">More About Our Company</h3>
					<p style="text-align:justify">RheinBrücke is an Epicor Platinum Partner and two times winner of International Partner of the Year, with a strong footprint in Europe, Middle East,
...
ing marketplace by ensuring their IT ecosystems are relevant, efficient and perfectly tuned.</p>
            ...
            <div class="col-md-4 pull-right">
                <h3 class="footer-h3">Contact Information</h3>
					<ul>
						<li><strong>Inserito</strong></li><br />
                          <li>Suite 903B, lbn Battuta Gate offices, Dubai, UAE</li>
						<li>+971 4 5545710</li>
						<li><a href="mailto:info@inserito.com">info@inserito.com</a> </li>
					</ul>
                </div>
        </div>
        <div class="row">
