<%@ Page Title="" Language="C#" MasterPageFile="~/Campaigns.master" AutoEventWireup="true" CodeBehind="epicor-for-construction.aspx.cs" Inherits="RheinBrucke.epicor_for_construction" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="owl-carousel">
        <div class="item" style="background-image: url(/Assets2/images/construction1-ov1.png); " >
        ...
        <div class="item" style="background-image: url(/Assets2/images/construction2-ov2.png);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6"></div>
...
<section id="cta" class="wow fadeIn">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h2>Overview</h2>
                <p>Epicor for Construction Overview</p>
            </div>
            <div class="col-sm-8 ">
