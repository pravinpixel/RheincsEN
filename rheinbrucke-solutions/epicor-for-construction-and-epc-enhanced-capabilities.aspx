<%@ Page Title="" Language="C#" MasterPageFile="~/Campaigns.Master" AutoEventWireup="true" CodeBehind="epicor-for-construction-and-epc-enhanced-capabilities.aspx.cs" Inherits="RheinBrucke.rheinbrucke_solutions.epicor_for_construction_and_epc_enhanced_capabilities" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="carousel-content">
                                 <h1 style="color: #fbcf00;">Enhanced Capablities</h1>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="carousel-content">
                                <h1 style="color: #fbcf00;">Enhanced Capablities</h1>
                                <h2>Epicor and RheinBrücke can help your company to reach new, industry-leading levels of business performance. </h2>
