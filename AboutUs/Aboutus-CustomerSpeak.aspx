        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb bread hidden-xs hidden-sm">
                    ...
                    <li><a href="#" class="redColor">Customer Speak</a></li>
                </ul>
                <div class="bg-img-testi img-responsive ">
                ...
                <div class="col-md-12 padd-top-20">
                    <h1 class="redColor">Customer Speak</h1>
                </div>
                ...
                <div class="main-container">
                    <div class="col-md-12  padd-top-40">
                        ...
                        <div class="col-md-4 marg-10">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">Thank you for the continued good work on the ERP and Supply Chain project. I was also pleased with the flexible, easily approachable, transparent .........<a data-toggle="modal" data-target="#myModal-Massimiliano">&nbsp&nbsp View more</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 marg-10 ">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">I had been using RheinBrücke team as my extended arm for sometime now and I have really come to appreciate their depth .........<a data-toggle="modal" data-target="#myModal-Craig">&nbsp&nbsp View more</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 marg-10 height">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">We implemented Epicor ERP for one of our large Glass manufacturing facility in Middle East. This is where we came across the German based .........<a data-toggle="modal" data-target="#myModal-Rizwanulla">&nbsp&nbsp View more</a></p>
                    ...
                    <div class="col-md-12 marg20 padd-top-40">
                        ...
                        <div class="col-md-4 marg-10">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">We were very impressed with the way RheinBrücke carried out their work. From analysis to implementation and post-production.........<a data-toggle="modal" data-target="#myModal-Syed">&nbsp&nbsp View more</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 marg-10">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">Our challenges made us to embark on our ERP journey and after lots of analysis, we choose Epicor ERP for RAY Group. We also faced.........<a data-toggle="modal" data-target="#myModal-Vinit">&nbsp&nbsp View more</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 marg-10">
                            ...
                            <div class="row col-md-12 padd-top-20">
                                <p class="ldr-marg text-justify">NGC Energy’s Epicor Implementation go-live happened earlier this year and at the end of Jan, we had successfully closed our Jan 2015 books.........<a data-toggle="modal" data-target="#myModal-Kiranjit">&nbsp&nbsp View more</a></p>
                            </div>
                        </div>
                        ...
                        <div class="modal-content center ">
                            <div class="modal-header1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row col-md-12 padd-top-20">
                                        <p class="ldr-marg text-justify">I had been using RheinBrücke team as my extended arm for sometime now and I have really come to appreciate their depth of technical and functional knowledge of the product and their commitment to our end customers needs. They react quickly to new challenges and are always there for me to rely on.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row col-md-12 padd-top-20">
                                        <p class="ldr-marg text-justify">“Our challenges made us to embark on our ERP journey and after lots of analysis, we choose Epicor ERP for RAY Group. We also faced initial hiccup and challenges during the implementations. This is where we came across the German based Rheinbrücke IT consulting and took their support. We leveraged their services for past 12 months and from this experience, I can definitely say that they did a fantastic turnaround of the project. I enjoyed the open, transparent and efficient dealing with them and came to appreciate their work. I understand that they recently started their Middle east and Africas operations, I wish them good luck and every success. "</p>
                                    </div>
                                </div>
