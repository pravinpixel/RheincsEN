<%@ Page Title="" Language="C#" MasterPageFile="~/Events/RheincsEventsGitex.Master" AutoEventWireup="true" CodeBehind="RheinBrücke-at-GITEX-2017.aspx.cs" Inherits="RheinBrucke.Events.RheinBrücke_at_GITEX_2017" %>
        ...
        <div class="container">
            <div class="col-sm-12 text-center">
                <div class="header-div-14">
                    <h1>Meet RheinBrücke at GITEX 2017 before</h1>
                    ...
                    <ul class="events-clock content-ul" id="counter">
                        ...
                        <li>
                            <div class="countdown-wrap">
                                <p><span class="countdown" id="seconds"></span></p>
                                <p><span class="count-unit">seconds</span></p>
                            </div>
                        </li>
                    </ul>
                    <div class="header14-div">
                        <ul class="content-ul header14-ul content-display-tc" id="hallinfo">
                            ...
                            <li><p><a href="#">Dubai World Trade Center Exhibition Hall</a></p></li>
                        </ul>
                        <ul class="content-ul header14-ul header14-ul-1 content-display-tc">
                            ...
                            <li><p><a href="#">08th - 12th October 2017 </a></p></li>
                        </ul>
                        <ul class="content-ul header14-ul header14-ul-1 content-display-tc"  style="margin-top:10px;">
                            ...
                            <li><p><a href="#">Hall 7, Booth B7-29</a></p></li>
                        </ul>
                    </div>
                    <div class="btn-top_space">
                     ...
                     <div class="header14-div">
                        <ul class="content-ul header14-ul content-display-tc">
                            <li><a href="#"><img src="Assets/GITEX/images/logos.png" class="img-responsive center-block" alt="30x30x1" /></a></li>
            ...
            <div class="event-row">
                ...
                <div class="col-xs-12 col-sm-6 about14 text-center">
                    <div class="about-event-right">
                        ...
                        <p class="first-para">
                            Achieve transcendence in Business through Technology @ Gitex 2017 
                        </p>
                        <p>
                            Meet our experts and be a part of exclusive 20-minute business sessions that will give you some ideas to expand your horizons leveraging business transforming digital solutions. 
                        </p>
                        <p> 
                            We are eager to showcase our innovative thought processes and highly engaging business solutions. Our sessions include real-world customer case studies, product and industry specific sessions, hands on sessions etc.  
                        </p>
                        <p>
                             Select sessions of your choice to meet the specific needs of your industry, designation, field, product and map out your customized agenda which will showcase how unprecedented digital value can be gained through technology. See for yourself the value of attending, and build your business case to attend.
                        </p>
    ...
    <div class="section-padding section-1-bg">
        <div class="container">
            <div class="row accord">
                <div class="col-sm-6 faq4-col-1">
                    <ul class="list-ul content-ul faq4-div">
                        <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                <div class="list-div-left">
                                    <i class="fa fa-chevron-circle-right"></i>
                                </div>
                                <div class="list-div-body">
                                    <h4 class="sessionName">Build your very own custom session </h4>
                                </div>
                            </div>     
                               </a>       
                        </li>
                        <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">Transforming HR: Creating Value Through People</h4>   
                                </div>
                            </div>   </a>  
                        </li>
                        <li class="content-li">
                          <a href="#hallinfo" style="color:#666666">  <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">Calculating the ROI for an ERP system implementation </h4>
                                </div>
                            </div> </a>
                        </li>
                         <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">Business driven BI and Analytics </h4>
                                </div>
                            </div> </a>
                        </li>
                        <li class="content-li">
                          <a href="#hallinfo" style="color:#666666">  <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">Technology ingredients that drive business to Hotels and Restaurants </h4>
                                </div>
                            </div> </a>
                        </li>
                    </ul>
                    ...
                    <ul class="list-ul content-ul faq4-div">
                        <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">MeRLIN – Empowering Modern Sourcing </h4>   
                                </div>
                            </div>     </a>
                        </li>
                        <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">Extending your Enterprise ERP - empowering end users </h4>    
                                </div>
                            </div>   </a>  
                        </li>
                        <li class="content-li">
                          <a href="#hallinfo" style="color:#666666">  <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">RheinBrücke Industry specific solutions for EPC companies</h4>
                                </div>
                            </div>  </a>
                        </li>
                         <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">RheinBrücke Epicor Mobility Solutions to optimize Field ticketing </h4>    
                                </div>
                            </div>    </a>      
                        </li>
                         <li class="content-li">
                           <a href="#hallinfo" style="color:#666666"> <div class="list-div accord-title">
                                ...
                                <div class="list-div-body">
                                    <h4 class="sessionName">RheinBrücke Industry specific solutions for Oil and Gas Companies</h4>
                                </div>
                            </div></a>
                        </li>
                    </ul>
            ...
            <div class="heading-div-1 text-center">
                ...
                <div class="events-schedule-div">
                    <ul class="content-ul two-col-ul content-display-tc">
                        ...
                        <li><p class="lettersize-13 content-spacing content-uppercase content-weight600 letter-height29"><a href="#" class="theme14-1-color">Dubai</a></p></li>
                    </ul>
                    <ul class="content-ul two-col-ul two-col-ul-1 content-display-tc">
                        ...
                        <li><p class="lettersize-13 content-spacing content-uppercase content-weight600 letter-height29"><a href="#" class="theme14-1-color">October 08<sup>th</sup> - 12<sup>th</sup> 2017 </a></p></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab">
                        ...
                        <div class="tab-content active">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-sm-pull-6 single-column-res-pull text-left schedule-col">
                                    <h3><a href="#" class="heading-tag-color">Day One</a></h3>
                                    <div class="">
                                        <ul class="list-ul content-ul schedule-ul-1">
                                            ...
                                            <li class="content-li">
                                                <div class="list-div">
                                                    ...
                                                    <div class="list-div-body">
                                                        <h5>Session 2: 4:15 PM to 4:45 PM </h5>
                                                    </div>
                                                </div>
                                           ...
                                           <li class="content-li">
                                             ...
                                             <li class="content-li">
                                                ...
                                                <p class="content-top-space">Business driven BI and Analytics</p>
                                            </li>
                                             <li class="content-li">
                                                <div class="list-div">
                                                    <div class="list-div-left">
                        ...
                        <div class="tab-content">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-left schedule-col single-column-res">
                                    <h3><a href="#" class="heading-tag-color">Day Two</a></h3>
                                    <div class="">
                                        <ul class="list-ul content-ul schedule-ul-1">
                                            <li class="content-li">
                                                <div class="list-div">
                                                    ...
                                                    <div class="list-div-body">
                                                        <h5>Session 1: 9:15 AM – 9:45 AM </h5>
                                                    </div>
                                                </div>
                                                <p class="content-top-space">Calculating the ROI for an ERP system implementation</p>
                                            </li>
                        ...
                        <div class="tab-content">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-sm-pull-6 single-column-res-pull text-left schedule-col">
                                    <h3><a href="#" class="heading-tag-color">Day Three</a></h3>
                                    <div class="">
                                        <ul class="list-ul content-ul schedule-ul-1">
                                            <li class="content-li">
                                                <div class="list-div">
                         ...
                         <div class="tab-content">
                            <div class="row">
                                <div class="col-sm-6 schedule-img section-respadding single-column-img">
                                    <img src="Assets/GITEX/images/image5.jpg" alt="image5" class="img-responsive" />
                                </div>
                                <div class="col-sm-6 text-left schedule-col single-column-res">
                                    <h3><a href="#" class="heading-tag-color">Day Four</a></h3>
                                    <div class="">
                                       <ul class="list-ul content-ul schedule-ul-1">
                                            <li class="content-li">
                                                <div class="list-div">
                        ...
                        <div class="tab-content">
                            <div class="row">
                                <div class="col-sm-6 col-sm-push-6 single-column-res-push schedule-img section-respadding">
                                    <img src="Assets/GITEX/images/image6.jpg" alt="image6" class="img-responsive" />
                                </div>
                                <div class="col-sm-6 col-sm-pull-6 single-column-res-pull text-left schedule-col">
                                    <h3><a href="#" class="heading-tag-color">Day Five</a></h3>
                                    <div class="">
                                       <ul class="list-ul content-ul schedule-ul-1">
                                            <li class="content-li">
                                                <div class="list-div">
                                            ...
                                            <li class="content-li">
                                                <div class="list-div">
                                                    ...
                                                    <div class="list-div-body">
                                                        <h5>Session 4: 4:15 PM – 4:45 PM</h5>
                                                    </div>
                                                </div>
                                                <p class="content-top-space">RheinBrücke Industry specific solutions for Engineering, Procurement & Construction (EPC) companies</p>
                                            </li>
