            ...
            <div class="sugar-crm" id="container-top">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <ul class="breadcrumb bread hidden-xs hidden-sm">
                            ...
                            <li><a href="#" class="redColor">Enterprise Solutions (ERP) &amp; Services<span> »
                                    </span></a></li>
                        ...
                        <div class="col-md-12 nopadding main-banners-bnr">
                            ...
                            <div class="banner-liners">
                                <div class="container lines">
                                    <h1>Business Intelligence <br>Services</h1>
                ...
                <div class="col-md-12 nopadding">
                    ...
                    <div class="row ms_section align-items-center sugar-crm">
                        <div class="col-lg-7 col-md-8 col-sm-12 col-12">
                            ...
                            <p class="common-para">Business Intelligence acts as a data manager, guiding enterprises
                                ...
                                proactive, making informed predictions about market shifts and customer behavior.</p>
                ...
                <div class="row">
                    <div class="col-lg-12 section-layer services">
                        ...
                        <p class="common-para mt-0">BI technologies enable organizations to derive meaningful insights
                                ...
                                <div class="resp-tabs-container">
                                    ...
                                    <div>
                                        <div class="row ms_section align-items-center">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <p class="common-para"><b>Data Engineering</b> is powered by <b>Azure
                                                    ...
                                                    volumes of structured data. <b> Databases</b> are handled by <b>
                                                        Azure SQL Database</b> and <b> Azure Cosmos DB,</b> supporting
                                                    both relational and multi-model data.<br><br>
                                    ...
                                    <div>
                                        <div class="row ms_section align-items-center">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding">
                                                <p class="common-para"><b>Epicor Data Analytics (EDA)</b> is a web-based
                                                    ...
                                                    integrating seamlessly with web and Excel interfaces.<br><br>
                                        ...
                                        <div class="row ms_section align-items-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 nopadding">
                                                ...
                                                <p class="common-para">
                                                    ...
                                                    analytics functionalities. <br><br>
