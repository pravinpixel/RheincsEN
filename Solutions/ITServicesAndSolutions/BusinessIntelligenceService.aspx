...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="sugar-crm" id="container-top">
            ...
            <div class="col-md-12 nopadding main-banners-bnr float-none">
               ...
               <div class="banner-liners">
                  <div class="container lines">
                     <div class="over-hidd">
                        <h1 class="common-topic h1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">Business Intelligence
                           <br>
                           Services
                        </h1>
                        <a data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-toggle="modal" onclick="Clear()" data-target="#myModal-contactus">Contact Us
                        </a>
                     </div>
                  </div>
               </div>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="section-layer ">
               <div class="over-hidd">
                  <h2 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="700" class="common-topic h1">Introduction
                  </h2>
                  <h3 class="common-topic" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="900">Uncover Insights with Business Intelligence (BI)
                  </h3>
                  <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1100">
            ...
            <div class="row ms_section align-items-center sugar-crm">
               <div class="col-lg-7 col-md-8 col-sm-12 col-12">
                  <div class="over-hidd">
                     <h3 class="common-topic" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1300">Benefits and Challenges of BI Implementation</h3>
                     <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
               ...
               <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                  <div class="over-hidd">
                     <div class="curve" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1700">
      ...
      <div class="col-lg-12 bg-lite-pink">
         <div class="over-hidd">
            <h2 class="common-topic h1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400">BI Service Offerings</h2>
         </div>
         <div id="verticalTab" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
            <div class="row">
      ...
      <div class="col-lg-12 section-layer services">
         <div class="over-hidd">
            <h2 class="common-topic" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">Technologies</h2>
            <p class="common-para mt-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
         ...
         <div class="demo pt-30" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="900">
            <div id="verticalTabs">
               <ul class="resp-tabs-list">
                  ...
                  <div>
                     <div class="row ms_section align-items-center">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-12 text-right">
                           <div class="image">
                              <a href="<%=rootpath %>solutions/it-services-and-solutions/business-intelligence-services/microsoft-fabric">
      ...
      <div class="col-lg-12 integrations-section">
         <div class="over-hidd">
            <h2 class="common-topic h1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">Integration with Enterprise Systems</h2>
         </div>
         <div class="over-hidd">
            <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
               Revolutionizing Tech Solutions: Microsoft Dynamics 365 and Microsoft Technologies Lead the Way.
            </p>
            <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700">
         ...
         <div class="over-hidd">
            <div class="integrating-img" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="900">
      ...
      <div class="col-lg-12 section-layer services">
         <div class="over-hidd">
            <h2 class="common-topic h1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">The RheinBrücke Advantage</h2>
         </div>
         <div class="row">
            <div class="col-lg-7">
               <div class="over-hidd">
                  <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
            ...
            <div class="col-lg-5">
               <div class="over-hidd">
                  <div class="r-advantage" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="900">
         ...
         <div class="over-hidd">
            <h3 class="common-topic small_heading pt-20" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Benefits of Choosing RheinBrücke</h3>
         </div>
         <!-- <p class="common-para">
         ...
         <div class="r-advantage-img pt-20">
            <div class="over-hidd">
               <div class="pnt-1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
               ...
               <div class="pnt-2" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="600">
               ...
               <div class="over-hidd">
                  <div data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="900"><img src="../../../Assets/images/infographic2.png" style="max-width: 600px;" class="img-responsive center-block" />
                  </div>
               </div>
               <div class="pnt-3" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
               ...
               <div class="pnt-4" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="600">
         ...
         <div class="section-layer nt-mp">
            <div class="row">
               <div class="col-lg-12 nopadding">
                  <div class="over-hidd">
                     <h2 class="common-topic h1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">Case Study</h2>
                     <p class="common-para" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
