<%@ Page Title="BrückeHR - Streamline Your Business | RheinBrücke"
    Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="BrückeHR.aspx.cs" Inherits="RheinBrucke.Solutions.EnterpriseServicesAndSolutions.BrückeHR" %>
    ...
    <div class="sugar-crm" id="container-top">
        <div class="col-md-12">
            ...
            <div class="row">
                <ul class="breadcrumb bread hidden-xs hidden-sm">
                    ...
                    <li><a href="#" class="redColor">BrückeHR</a></li>
            ...
            <div class="section-layer">
                <div class="row">
                    <div class="col-lg-12 nopadding">
                        <h2 class="common-topic">What Makes BrückeHR Stand Out</h2>
					</div>
            ...
            <div class="section-layer pb-0">
                ...
                <div class="row mb-50">
                    <div class="col-lg-12 nopadding">
                        ...
                        <p class="common-para">
                            BrückeHR is a complete Human Capital Management (HCM) solution that handles many aspects of talent<br> management. Here are some of its main features:
                        </p>
                    </div>
                </div>
                <div class="row mb-50">
                    <div class="col-lg-12 nopadding">
                        <div class="img-boxer">
                            <img alt="Recruitment & Onboarding,Probation,Compensation,Performance Management,Training & Development,Leadership Development,Reports and Analytics,Travel & Reimbursement,Time & Attendance,Grievance Redressal,Exit & Final Settlement" src="../../../Assets/images/rhei.jpg" class="img-responsive center-block" style="width: 75%;" />
                        </div>
                    </div>
        ...
        <div class="col-md-12 nopadding set-5">
            ...
            <div class="section-layer">
                ...
                <div class="row mb-30">
                    <div class="col-lg-12 nopadding">
                        <h2 class="common-topic">Additional Features of BrückeHR
                        </h2>
                ...
                <div class="row">
                    <div class="col-lg-12 nopadding">
                        ...
                        <p class="common-para pb-30">
                            BrückeHR provides a comprehensive solution for talent management for employees, managers and HR department. With BrückeHR, you can enjoy:
                        </p>
