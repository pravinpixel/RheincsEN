<%@ Page Title="Discover the Best Cloud ERP Software & Implementation Strategies" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="epicor-cloud.aspx.cs" Inherits="RheinBrucke.Solutions.EnterpriseServicesAndSolutions.EpicorCloud.epicor_cloud" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headerPlaceHolder" runat="server">
    ...
    <meta name="Description" content="Explore the best cloud ERP software and implementation strategies with RheinBrücke. Optimize your operations." />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <style>
        ...
        #accordion4 .panel-title a, #accordion41 .panel-title a {
            ...
            #accordion4 .panel-title a.collapsed:before, #accordion41 .panel-title a.collapsed:before {
                content: "\f107";
            }
    ...
    <div class="container" id="container-top">
        ...
        <div class="row">
            ...
            <div class="col-md-12 contentwithpadding rheincs-container">
                ...
                <div class="clearfix">&nbsp;</div>
                <h2 class="redColor">Reasons to choose Epicor on the Cloud</h2>
                <div class="mainContent-normal contentdiv" style="text-align: justify">
                ...
                <div class="mainContent-normal contentdiv" style="text-align: center">
                    <a href="#" data-toggle="modal" data-target="#knowmoreform">
                        <div class="cta-new center-block">Know More</div>
                    </a>
                </div>
                <div class="clearfix">&nbsp;</div>
                ...
                <br />
                <div class="clearfix"></div>
                <h2 class="redColor">Industry Vertical Solutions: </h2>
                ...
                <br />
                <div class="clearfix"></div>
                <h2 class="redColor">Epicor on the Cloud Modules</h2>
                <div class="col-md-5">
                    <div class="col-md-12">
                        <ul>
                            <li>
                ...
                <div class="col-md-7">
                    <img src="../../../Assets/images/epicoroncloud-modules.png" alt="Epicor-Cloud-Modules" class="img-responsive center-block" />
                </div>
                <div class="clearfix">&nbsp;</div>
                <h2 class="redColor">What you need to know if you are planning a Cloud ERP Implementation in the near future:</h2>
                ...
                <h4 class="redColor">Additional assistance: </h4>
                <div id="form-div"></div>
        ...
        <div class="col-md-12">
            <h2 class="redColor">Related Blogs</h2>
            <p style="font-size: 1.3em"><b><a href="https://blog.rheincs.com/post/five-benefits-of-moving-erp-to-the-cloud/ ">Five benefits of moving ERP to the Cloud.</a></b></p>
            <br />
            <p style="font-size: 1.3em"><b><a href="https://blog.rheincs.com/post/erp-on-the-cloud-for-the-manufacturing-industry/ ">ERP on the Cloud for the Manufacturing Industry</a></b></p>
            <br />
            <p style="font-size: 1.3em"><b><a href="https://blog.rheincs.com/post/roi-of-a-modern-erp-cloud-solution/ ">ROI of A Modern ERP Cloud Solution</a></b></p>
            <br />
