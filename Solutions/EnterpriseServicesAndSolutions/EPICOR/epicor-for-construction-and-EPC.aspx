...
<asp:Content ID="Content1" ContentPlaceHolderID="headerPlaceHolder" runat="server">
   <meta name="keywords" content="ERP for construction management, construction and epc solutions, engineering procurement and construction management, construction erp software, erp software for construction industry, construction and epc softwares, best erp software for construction" />
     ...
     <div class="container" id="container-top">
         ...
         <div class="row">            
            <ul class="breadcrumb bread hidden-xs hidden-sm">
                ...
                <li><a href="#" class="redColor">Epicor For Construction</a></li>
            </ul>       
         </div>
         <!--Eof Breadcrumb row-->
         <!-- Slider Starts here-->
                ...
                <div class="row paddingGreycontainer bgcol">
                    ...
                    <div class="row col-md-12 padding">
                        <div class="col-md-4">                           
                                ...
                                Epicor for Construction and EPC goes beyond traditional project-based ERP by using a modern service-oriented architecture (SOA).</p>
                                    </div>
                      ...
                      <div class="col-md-4">                           
                                    ...
                                    <p class="bulletContent-epicor-inner-epc">
                                Strong revenue recognition capabilities including profitability tracking, better visibility and margin control.</p>
                                    </div>
                        ...
                        <div class="col-md-4">                           
                                    <div class="redBullets-epicor-inner "></div>
                                    <p class="bulletContent-epicor-inner-epc">
                                Comprehensive project management including multilevel work breakdown structures, robust resource scheduling, and effective contract management.</p>
                                    </div>
                    ...
                    <div class="row col-md-12 padding">
                       <div class="col-md-4">                           
                                    ...
                                    <p class="bulletContent-epicor-inner-epc">
                               Efficient bid management through embedded CRM capabilities including visibility of historical bids.</p>
                                    </div>
                        ...
                        <div class="col-md-4">                           
                                    ...
                                    <p class="bulletContent-epicor-inner-epc">
                               Accurate and timely billing of project costs through seamless collection of time, material and expense transactions, backed by flexible revenue recognition management.</p>
                                    </div>
