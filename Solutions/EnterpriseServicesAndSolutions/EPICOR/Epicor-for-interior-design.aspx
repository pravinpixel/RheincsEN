                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            ...
                            <p class="bulletContent-epicor padd-left-10">Multiple billing options including applications for payment and variations tracking are fully incorporated within project management</p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            ...
                            <p class="bulletContent-epicor padd-left-10">Everything revolves around the project including the ability to purchase and receive directly into a project</p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            <div class="redBullets-epicor-onbg"></div>
                            <div class="redColor-epicor bulletContent">
                                <strong>MULTI-LEVEL WORK BREAKDOWN</strong>
                            </div>
                            <p class="bulletContent-epicor padd-left-10">Unlimited WBS levels with control over details held and ability to record or accumulate costs through the WBS</p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            <div class="redBullets-epicor-onbg"></div>
                            <div class="redColor-epicor bulletContent">
                                <strong>RESOURCE SCHEDULING</strong>
                            </div>
                            <p class="bulletContent-epicor padd-left-10">Project management is deeply embedded ensuring project operations and resources are available for planning and scheduling using Epicor APS</p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            ...
                            <p class="bulletContent-epicor padd-left-10">Dashboards, KPIs and Trackers for analysis and understanding of project status </p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            <div class="redBullets-epicor-onbg"></div>
                            <div class="redColor-epicor bulletContent">
                                <strong>REAL TIME COST CAPTURE</strong>
                            </div>
                            <p class="bulletContent-epicor padd-left-10">All costs are captured against projects with real-time visibility and alerts </p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            ...
                            <p class="bulletContent-epicor padd-left-10">Multiple methods of revenue recognition available to provide consistent and demonstrable calculations ensuring compliance with stated policies</p>
                        </li>
                    </ul>
                ...
                <div class="col-md-3">
                    <ul>
                        <li>
                            <div class="redBullets-epicor-onbg"></div>
                            <div class="redColor-epicor bulletContent">
                                <strong>TIME AND EXPENSE MANAGEMENT</strong>
                            </div>
                            <p class="bulletContent-epicor padd-left-10">Comprehensive time and expense entry and approval to ensure accurate and timely compliance with time and expense recording policies and complete cost capture</p>
                        </li>
                    </ul>
