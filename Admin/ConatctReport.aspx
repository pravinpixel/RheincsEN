<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ConatctReport.aspx.cs" Inherits="RheinBrucke.Admin.ConatctReport" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: _rootUrl + "api/Admin/ContactSearchReport",
                        ...
                        if (response != "") {
                            ...
                            if (JSON.parse(response) != null && response != "") {
                                ...
                                for (var i = 0; i < Data.length ; i++) {
                                    if (Data[i].ContactUsUrl == null || Data[i].Services == null || Data[i].Message == null) { Data[i].ContactUsUrl = ""; Data[i].Services = ""; Data[i].Message = ""; }
                                    $('#tbody').append("<tr style='border-bottom: 1px #d1d2d4 solid;'><td style='padding-left:10px;'>" + Data[i].Name + "</td><td>" + Data[i].Phone + "</td><td>" + Data[i].Email + "</td><td>" + Data[i].EmailTypeName + "</td><td>" + Data[i].Message + "</td><td>" + Data[i].Services + "</td><td>" + Data[i].ContactUsUrl + "</td></tr>");
                                }
                            }
                        }
                        else {
            ...
            $('#btnClear').click(function () {
                $('#tbody').empty(); $('#txtdatefrom,#txtdateto').val('');
                cleardatatable();
            });
    ...
    <div class="container" id="container-top" style="padding-top: 12px">
        ...
        <div class="row">
            <h5 class="deco-header" style="margin-left: 20px;">
                <span class="redBottom">Contact Report</span>
            </h5>
        </div>
        <br />
