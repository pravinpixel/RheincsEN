<%@ Page Title="Manage Webinars" Language="C#" MasterPageFile="~/AdminMaster.Master" validateRequest="false" AutoEventWireup="true" CodeBehind="WebinarsRecordings.aspx.cs" Inherits="RheinBrucke.Admin.WebinarsRecordings" %>
...
<style>
    ...
    <div class="container" id="container-top" style="padding-top:12px;">     
        <div class="col-md-12">
            <h5 class="deco-header">
                <span class="redBottom">Add/Edit Webinars Recordings</span></h5>
           ...
           <div id="divErrorMessage" runat="server" class="validator"></div>
            ...
            <br /><br /><br />
                  <input type="hidden" id="hdnWebinarsid" value='<%# Eval("WebinarRecId") %>' runat="server" />
    ...
    <div class="clearfix">&nbsp;&nbsp;</div>
               ...
               <h5 class="deco-header" style="margin-left: 20px;">
                <span class="redBottom">List of Webinars Recordings</span></h5>
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td> <%# Eval("WebinarURL") %></td>                    
                        <td class="text-center">
                            <asp:LinkButton  OnClick="btnEdit_Click" CommandArgument='<%# Eval("WebinarRecId") %>' runat="server">
                            <i class="fa fa-edit"></i>
                                </asp:LinkButton>
                        </td>                        
                        <td class="text-center">
                            <asp:LinkButton OnClick="btnDelete_Click" CommandArgument='<%# Eval("WebinarRecId") %>' runat="server">
