...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="Features" class="top-70">
        <div class="container">
            ...
            <div class="aos-init aos-animate bt-70" data-aos="zoom-out-up">
                <div class="text-center">
                    <h1 class="hdg-h1">What are MeRLIN’s features?</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/supplier-relationship.png" alt="Supplier Relationship Management" class="icon-hdg" /></div>
                        <h3 class="what-h1">Supplier Relationship</h3>
                        <ul class="custom-li">
                            <li>Manage Supplier life cycle from onboarding, scaling up/down their scope of supply, rating and maintaining their performance and removal from supply chain through configurable approvals
                            </li>
                ...
                <div class="col-md-4 min-width-35">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/eprocurement.png" alt="eProcurement" class="icon-hdg" /></div>
                ...
                <div class="col-md-4 min-width-31">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/eprocurement2.png" alt="Analytics" class="icon-hdg" /></div>
                        ...
                        <ul class="custom-li custom-li-auto">
                            ...
                            <li>Get summary as well as filtered data of a variety of business data elements through standard reports
                            </li>
                            <li>Summarize, slice and dice data through self-service data explorer, create custom reports and perform what-if analytics.
                            </li>
                ...
                <div class="col-md-4">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/analytics.png" alt="Budgeting & Planning" class="icon-hdg" /></div>
                ...
                <div class="col-md-4">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/Master-Data-Handling.png" alt="Data Handling" class="icon-hdg" /></div>
                ...
                <div class="col-md-4">
                    <div class="aos-init aos-animate benefit-div" data-aos="zoom-in-up">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/Compliance-and-Auditing.png" alt="Compliance and Auditing" class="icon-hdg" /></div>
    ...
    <div id="infograph" class="top-70">
        <div class="container">
            <div class="aos-init bt-70 aos-animate" data-aos="zoom-out-up">
                <div class="text-center">
                    <h2 class="hdg-h1">Why MeRLIN?</h2>
            ...
            <div class="row hidden-md hidden-lg">
                ...
                <div class="text-center">
                    <img style="width: 150px;" src="MeRLINWebsite/images/MeRLIN-logo.svg" alt="MeRLIN Logo" />
                </div>
                <div class="text-center">
    ...
    <div id="benefit" class="top-70">
        <div class="container">
            <div class="aos-init aos-animate bt-70" data-aos="zoom-out-up">
                <div class="text-center">
                    <h2 class="hdg-h1">Who will benefit from MeRLIN?</h2>
            ...
            <div class="row">
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-right">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/TAT.png" alt="Shorter Turn Arounds" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
                        <h3 class="desc-h1">Quick Turn Arounds</h3>
                        <p class="layout-p">Enterprises that frequently need to respond to customer RFIs with competitive pricing and other terms can use MeRLIN’s online quote eSourcing function to aggregate Supplier quotes providing rapid response to customer RFIs while minimizing manual errors</p>
                    </div>
                ...
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-left">
                    ...
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/largebuysmallbuy.png" alt="Large Buy vs Build" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
                        <h3 class="desc-h1">Large Buy vs Build</h3>
                        <p class="layout-p">Enterprises whose bottom line will have significant impact based on savings from sourcing functions will be able to leverage MeRLIN’s powerful analytics to drive cost savings.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-right">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/Disparate-Sourcing.png" alt="Disparate Sourcing" class="icon-benefit" />
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-left">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/datadrivensourcing.png" alt="Data Driven Sourcing" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
    ...
    <div id="tangible-benefit" class="top-70">
        <div class="container">
            <div class="aos-init aos-animate bt-70" data-aos="zoom-out-up">
                <div class="text-center">
                    <h2 class="hdg-h1">What are the tangible benefits?</h2>
            ...
            <div class="row">
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-right">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/TAT.png" alt="" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
                        <h3 class="desc-h1">Shorter Turn Arounds</h3>
                        <p class="layout-p">Respond faster to customer RFIs and improve top line by discovering existing prices in the system or getting quicker quotes via a fully online eSourcing module</p>
                    </div>
                ...
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-left">
                    ...
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/spend.png" alt="Cost Savings" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
                        <h3 class="desc-h1">Improved Cost Savings</h3>
                        <p class="layout-p">Rationalize suppliers and items by discovering spend and savings patterns across categories, suppliers and regions at the lowest possible granularity using MeRLIN’s powerful Spend Analytics</p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-right">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/online.png" alt="Global Sourcing" class="icon-benefit" />
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-left">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/suppliers.png" alt="Supplier Relationship" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-right">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/Risk-Mitigation.png" alt="Risk Mitigation" class="icon-benefit" />
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="col-md-6 aos-init aos-animate benefit-div" data-aos="fade-left">
                    <div class="col-md-3">
                        <div class="text-center">
                            <img src="MeRLINWebsite/images/Enhanced-RoI.png" alt="Enhanced RoI" class="icon-benefit" /></div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="container-contact2">
                    <div class="wrap-contact2">
                        <form class="contact2-form validate-form" role="form" id="form1" method="post">
                            <span class="contact2-form-title">Ready to see MeRLIN in action?
                            </span>
                            <span class="success-msg">Thank you for Submitting the form.
                                <br />
                            </span>
