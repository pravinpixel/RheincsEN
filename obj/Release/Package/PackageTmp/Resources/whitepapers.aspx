<%@ Page Title="Resources: Whitepaper | RheinBrücke" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="whitepapers.aspx.cs" Inherits="RheinBrucke.Resources.whitepapers" %>
    ...
    <div class="container" id="container-top">
       <div class="row">
             <ul class="breadcrumb bread hidden-xs hidden-sm">
                 ...
                 <li ><a href="#" class="redColor">Whitepapers</a></li>
        ...
        <div class="wrappernew main-container">
                    <h1 class="redColor">Whitepapers</h1>
            </div>
