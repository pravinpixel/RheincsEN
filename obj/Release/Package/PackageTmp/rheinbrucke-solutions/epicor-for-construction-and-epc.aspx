<%@ Page Title="" Language="C#" MasterPageFile="~/Campaigns-EPC.Master" AutoEventWireup="true" CodeBehind="epicor-for-construction-and-epc.aspx.cs" Inherits="RheinBrucke.rheinbrucke_solutions.epicor_for_construction_and_epc" %>
                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="<%=rootpath %>">
                                <img class="logo-img logo-img-main" src="../Assets2/hcm-assets/img/RIC-logo.png" alt="Asentus Logo"/>
                                <img class="logo-img logo-img-active" src="../Assets2/hcm-assets/img/RIC-logo.png" alt="Asentus Logo"/>
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
...
<section id="main-slider">
    <div class="owl-carousel">
        <div class="item" style="background-image: url(../Assets/EPC/img/construction1-ov1.jpg);">
        ...
        <div class="item" style="background-image: url(../Assets/EPC/img/construction2-ov2.jpg); " >
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="item" style="background-image: url(/Assets/EPC/img/performance-ec2.jpg);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
         ...
         <div class="item" style="background-image: url(/Assets/EPC/img/revenue-adv2.png);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
