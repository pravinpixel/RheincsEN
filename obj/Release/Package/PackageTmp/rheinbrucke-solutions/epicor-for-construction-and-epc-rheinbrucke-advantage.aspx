<%@ Page Title="" Language="C#" MasterPageFile="~/Campaigns.Master" AutoEventWireup="true" CodeBehind="epicor-for-construction-and-epc-rheinbrucke-advantage.aspx.cs" Inherits="RheinBrucke.rheinbrucke_solutions.epicor_for_construction_and_epc_rheinbrucke_advantage" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="carousel-content">
                               <h1 style="color: #fbcf00;">RheinBrücke advantage</h1>
                                <h2>RheinBrücke believes that a successful ERP implementation is very crucial as it impacts almost every aspect of your EPC business. Here’s how we help our clients to thrive in competitive markets. </h2>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="carousel-content">
                                <h1 style="color: #fbcf00;">RheinBrücke advantage</h1>
                                <h2>Derive, strong revenue recognition capabilities including profitability leveraging Epicor for Construction and EPC</h2>
