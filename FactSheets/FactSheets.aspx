    ...
    <div class="container" id="container-top">
        <div class="row">
            <ul class="breadcrumb bread  hidden-xs hidden-sm">
                ...
                <li class="redColor">FactSheets</li>
            </ul>
        </div>
        ...
        <div class="row" id="filter-search">
                ...
                <asp:Repeater ID="rptNewsEvents" runat="server">
                    <ItemTemplate>                     
                        <div class="col-md-3 col-xs-12 col-sm-6 success-padding-left padd-left-72">                          
                            ...
                            <br />
                              <a style="color: #2f2f2f;" class="readmore" data-toggle="modal" data-target="#myModal-factsheet" data-id="<%# Eval("Description") %>" data-value ="<%=rootpath %>Assets/images/FactSheets/Thumbnail/<%# Eval("Thumbnail") %>">                                              
         ...
         <div class="modal fade" id="myModal-factsheet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content mymodal-download">
                    ...
                    <div class="modal-body">
                     ...
                     <div class="modal-body">
                        <p>
                            <input type="text" placeholder="*Company Name" id="textcompany" class="write-to-us-input" name="factsheets-company"/>
                        </p>
                    ...
                    <script type="text/javascript">                         
                        function saveleadwhitepaper() {
                            ...
                            var fieldMapping = {
                                ...
                                MXHAsc: "",
                                FirstName: "factsheet-name",
                                EmailAddress: "factsheet-email",
                                Mobile: "factsheet-phone"
                            };
                            ...
                            new LSQForm().captureLead(fieldMapping, "myModal-factsheet",
                            {
